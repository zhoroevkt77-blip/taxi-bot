...
def _invite_block(account, platform, lang="ky"):
    ...
    if lang == "ru":
        if platform == "telegram":
            tail = ("<i>Нажмите кнопку ниже — откроется список "
                    ...
                    "Нажмите <b>кнопку пересылки</b> справа от "
                    "этого сообщения — откроется список контактов, "
                    "выберите друга.\n"
                    "<i>Если её нет: задержите палец на сообщении и "
                    "выберите «Переслать».</i>")
    ...
    if platform == "telegram":
        tail = ("<i>Төмөнкү баскычты бассаңыз, контакттарыңыз "
                ...
                "Ушул кабардын оң жагындагы <b>кош жебе</b> "
                "белгисин басыңыз — контакттарыңыз ачылат, "
                "досуңузду тандайсыз.\n"
