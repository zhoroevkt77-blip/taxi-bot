...
class Button:
    ...
    url коюлса — баскыч басылганда ботко кабар келбейт, дароо ошол
    шилтеме ачылат (Telegram inline URL баскычы). Ал учурда action
    колдонулбайт, бирок бош калбашы үчүн "noop" деп жазылат.

    WhatsApp'та URL баскычы жок — адаптер аны жөн эле текст катары берет.
    """
    text: str          # Колдонуучуга көрүнчү жазуу
    action: str        # core логикасы тааныган ички код, мис. "route:to_bishkek"
    url: str = None    # Коюлса — баскыч түз шилтемени ачат
